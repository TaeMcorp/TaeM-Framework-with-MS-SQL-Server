...
namespace Memberships.Console
{
    class Program
    {
        ...
        private static void CallBusiness()
        {
            ...
            Member createdMemberInDB = new BizMemberShip(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).CreateMember(newMember);
            WriteMember(createdMemberInDB);

            // Select member
            Member selectedMemberInDB = new BizMemberShip(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).GetMember(createdMemberInDB.MemberID);
            WriteMember(selectedMemberInDB);


            // Create new member
            Member newMember2 = new Member("Jane Doe", true, "jane@taemcorp.net", "080-00-0234-5378", "anywhere");
            Member createdMemberInDB2 = new BizMemberShip(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).CreateMember(newMember2);
            WriteMember(createdMemberInDB2);

            // Get member
            Member selectedMemberInDB2 = new BizMemberShip(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).GetMember(createdMemberInDB2.MemberID);
            WriteMember(selectedMemberInDB2);


            // Get members
            List<Member> currentMembers = new BizMemberShip(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).GetMembers(string.Empty);
            WriteMembers(currentMembers);

            // Get numboer of members
            int numOfCurrentMembers = new BizMemberShip(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).GetNumsOfMembers(string.Empty);
            ...
            bool updateResult = new BizMemberShip(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).SetMember(createdMemberInDB);

            if (updateResult)
            {
                Member updatedMember = new BizMemberShip(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).GetMember(createdMemberInDB.MemberID);
                WriteMember(updatedMember);
            }

            // Delete Member
            bool deleteResult = new BizMemberShip(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).RemoveMember(createdMemberInDB.MemberID);

            List<Member> afterDeletedMembers = new BizMemberShip(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).GetMembers(string.Empty);
        ...
        private static void CallBusinessSP()
        {
            // Create new member
            Member newMember = new Member("John Doe", true, "john@taemcorp.net", "080-00-1234-5678", "anywhere");
            Member createdMemberInDB = new BizMemberShipSP(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).CreateMember(newMember);
            WriteMember(createdMemberInDB);

            // Select member
            Member selectedMemberInDB = new BizMemberShipSP(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).GetMember(createdMemberInDB.MemberID);
            WriteMember(selectedMemberInDB);


            // Create new member
            Member newMember2 = new Member("Jane Doe", true, "jane@taemcorp.net", "080-00-0234-5378", "anywhere");
            Member createdMemberInDB2 = new BizMemberShipSP(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).CreateMember(newMember2);
            WriteMember(createdMemberInDB2);

            // Get member
            Member selectedMemberInDB2 = new BizMemberShipSP(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).GetMember(createdMemberInDB2.MemberID);
            WriteMember(selectedMemberInDB2);


            // Get members
            List<Member> currentMembers = new BizMemberShipSP(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).GetMembers(string.Empty);
            WriteMembers(currentMembers);

            // Get numboer of members
            int numOfCurrentMembers = new BizMemberShipSP(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).GetNumsOfMembers(string.Empty);
            WriteCurrentNumberOfMemers(numOfCurrentMembers);
            ...
            bool updateResult = new BizMemberShipSP(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).SetMember(createdMemberInDB);

            if (updateResult)
            {
                Member updatedMember = new BizMemberShipSP(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).GetMember(createdMemberInDB.MemberID);
                WriteMember(updatedMember);
            }

            // Delete Member
            bool deleteResult = new BizMemberShipSP(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).RemoveMember(createdMemberInDB.MemberID);

            List<Member> afterDeletedMembers = new BizMemberShipSP(MS_SQL_PROVIDER_NAME, MS_SQL_CONN_STR).GetMembers(string.Empty);
            WriteMembers(afterDeletedMembers);
        }
